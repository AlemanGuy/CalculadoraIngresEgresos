let ingresos = [
    ...
    new Ingreso('FREELANCE', 15000),
    new Ingreso('VENTA DE GARAGE', 10000)
];

let egresos = [
    new Egreso('RENTA DEL DEPA', 5500),
    new Egreso('COMPRAR ROPA', 800),
    new Egreso('RENTA DE LOCAL', 800),
    new Egreso('BOLETOS DE CONCIERTOS', 15000)
];
